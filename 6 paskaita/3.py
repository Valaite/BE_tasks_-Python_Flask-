...
# Sukurti tėvinę klasę Irasas, kurioje būtų savybės suma , iš kurios klasės PajamuIrasas ir 
# IslaiduIrasas paveldėtų visas savybes.
...
# Atitinkamai perdaryti klasės Biudzetas metodus gauti_balansa ir gauti_ataskaita kad 
# pasiėmus įrašą iš žurnalo, atpažintų, ar tai yra pajamos ar išlaidos (pvz., panaudojus 
# isinstance() metodą) ir atitinkamai atliktų veiksmus.
